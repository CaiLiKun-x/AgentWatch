...
Write-Host ""
Write-Host "  4. Install hooks for the agent you use (optional but recommended):"
Write-Host "     powershell -ExecutionPolicy Bypass -File windows\install_claude_hooks_windows.ps1"
Write-Host "     powershell -ExecutionPolicy Bypass -File windows\install_codex_hooks_windows.ps1"
Write-Host ""
